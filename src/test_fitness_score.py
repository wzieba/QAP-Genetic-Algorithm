...
class TestFitnessScore(TestCase):
    ...
    def test_fitness_scores_match(self):
        ...
        self.assertEqual([908, 790, 990, 858, 834], fitness_scores_list)

    def test_normalized_fitness_scores(self):
        fitness_scores_list = compute_fitness_scores_list(TEST_POPULATION, DISTANCE_MATRIX, FLOW_MATRIX)
        normalized_fitness_scores_list = get_normalized_result_of_fitness_function_scores_list(fitness_scores_list)
    ...
    def test_normalized_fitness_score_values(self):
        fitness_scores_list = compute_fitness_scores_list(TEST_POPULATION, DISTANCE_MATRIX, FLOW_MATRIX)
        scores_list = get_normalized_result_of_fitness_function_scores_list(fitness_scores_list)
